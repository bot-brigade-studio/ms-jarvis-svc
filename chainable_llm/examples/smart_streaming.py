    ...
    try:
        ...
        if complexity >= 7 or requires_breakdown:
            return RouteDecision(
                ...
                system_prompt_additions=analysis.get(
                    "breakdown_guidance",
            ...
            return RouteDecision(
                ...
                system_prompt_additions=analysis.get(
                    "simplification_guidance", "Focus on clarity and simplicity."
                ),
            )
        else:
            return RouteDecision(
                route_id="final_response", user_input_transform=context.original_input
            )
...
7-10: Complex topics requiring breakdown""",
        ...
        stream_callback=stream_callback,
        routes={"small_model": small_model, "final_response": final_response},
    )
