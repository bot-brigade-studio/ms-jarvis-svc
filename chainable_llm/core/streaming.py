...
from core.types import StreamChunk, StreamConfig
from core.exceptions import ChainableLLMError
...
class StreamBuffer:
    ...
    def _should_flush(self, done: bool = False) -> bool:
        ...
        """
        return (
            self.buffer_size >= self.config.chunk_size or
    ...
    async def process_chunk(self, content: str, done: bool = False) -> Optional[StreamChunk]:
        """
