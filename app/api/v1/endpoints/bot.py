...
async def create_bot_config(
    id: UUID, schema: BotConfigCreate, service: BotService = Depends()
):
...
async def update_bot_config(
    id: UUID, config_id: UUID, schema: BotConfigCreate, service: BotService = Depends()
):
...
async def update_bot_config_is_current(
    id: UUID, config_id: UUID, service: BotService = Depends()
):
